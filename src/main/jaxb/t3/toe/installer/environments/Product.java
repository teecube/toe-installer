 ...
 *       &lt;attribute name="onError" type="{http://teecu.be/toe-installer/environments}ProductOnErrorBehaviour" default="fail" /&gt;
 *       &lt;attribute name="executePostInstallCommandsWhenSkipped" type="{http://www.w3.org/2001/XMLSchema}boolean" default="false" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public abstract class Product {
    ...
    protected ProductOnErrorBehaviour onError;
    @XmlAttribute(name = "executePostInstallCommandsWhenSkipped")
     ...
     * @return
     *     possible object is
     *     {@link ProductOnErrorBehaviour }
     *     
     */
    public ProductOnErrorBehaviour getOnError() {
        if (onError == null) {
            return ProductOnErrorBehaviour.FAIL;
        } else {
            return onError;
        }
    }
     ...
     *     
     */
    public void setOnError(ProductOnErrorBehaviour value) {
        this.onError = value;
    }

    /**
     * Gets the value of the executePostInstallCommandsWhenSkipped property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     *     
     */
    public boolean isExecutePostInstallCommandsWhenSkipped() {
        if (executePostInstallCommandsWhenSkipped == null) {
            return false;
        } else {
            return executePostInstallCommandsWhenSkipped;
        }
    }

    /**
     * Sets the value of the executePostInstallCommandsWhenSkipped property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setExecutePostInstallCommandsWhenSkipped(Boolean value) {
        this.executePostInstallCommandsWhenSkipped = value;
    }
